            ...
            <div key={review.id} className="review-item">
              <div className="review-item-1">
                <p className="p-detail">
                  <span className="bold-span">Posted By:</span>{" "}
                  <b>{review.reviewSender.username}</b>
                </p>

                <p className="red-star">
                  <span className="rate-span">Rating:</span>{" "}
        ...
        <div className="comment-box">
          ...
          <div className="stars">
            <div className="rating">
              ...
              />
              <label htmlFor="5" className="fs-40px">
                ☆
              </label>
              <input
                type="radio"
          ...
          <div className="mt-3">
            <button
              className="btn btn-sm send-review-btn"

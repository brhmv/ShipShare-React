                                        ...
                                        BannerData.AgencyText.map(Agency => {
                                            return (
                                                <React.Fragment key={Agency.id}>
                                                    ...
                                                    <h2 className="f_700 t_color3 mb_40 wow fadeInLeft" data-wow-delay="0.3s">Send Anywhere, Travel Everywhere</h2>
                                                    <p className="f_400 l_height28 wow fadeInLeft" data-wow-delay="0.4s">ShipShare connects shoppers and travelers who help each other access the world.</p>
                                                </React.Fragment>
                                            )
                                        })
                                    }
